...
download packages from the `Downloads </doc/download.html>`_ and install
them. They will still be in Debian Unstable, but they won't be in Debian
Testing and the next Debian Stable.
