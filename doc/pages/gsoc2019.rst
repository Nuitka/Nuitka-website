...
See our `introduction <http://nuitka.net/pages/overview.html>`__ for a
full summary and consider reading the `user manual
<http://nuitka.net/doc/user-manual.html>`__ and the `developer manual
<http://nuitka.net/doc/developer-manual.html>`__ for further
clarification.
...
<http://nuitka.net/doc/user-manual.html>`_. Using Anaconda Python on
Windows, or a normal Linux system, and you are good to go with a git
clone of Nuitka in a minute. See `Download page
<http://nuitka.net/pages/download.html>`_ how to do that.
