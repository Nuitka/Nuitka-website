...
For the purpose of GSoC the Nuitka development mailing list can be used, as
well as private email. We will be reachable via Hangout/Duo calls on a regular
basis.
...
* Jorj X. McKie <jorj.x.mckie@outlook.de>, contributor and create of
...
Potential mentors: Kay Hayen, Kamran Ghanaat, Jorj X. McKie
...
Potential mentors: Kay Hayen, Kamran Ghanaat
...
using loops are loosing out on many optimization opportunities.

The students task would be to immitate existing built-in codes to achieve a
