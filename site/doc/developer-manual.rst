...
#. Feature parity with CPython, understand all the language construct
   ...
   target any older CPython release. For CPython 3.4 up to 3.13 it also
   has been reached (not all 3.12+ features are currently fully working
   though). We do not target the older and practically unused CPython
   3.0 to 3.3 releases.
