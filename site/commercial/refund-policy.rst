...
works for your project and meets your needs before purchasing a
...
-  **Higher-tier commercial users** (priority support packages) are
   ...
   commercial features will be fixed.

-  For all other commercial users, the standard community support
   channels apply.

Failure of Nuitka to compile your specific code, or the standard version
not working for your use case, is not grounds for a refund.
