...
consider reading the `User Manual
</user-documentation/user-manual.html>`__ and the `Developer Manual
</doc/developer-manual.html>`__ for further clarification.
...
</user-documentation/user-manual.html>`_. Using Anaconda Python on
Windows, or a normal Linux system, and you are good to go with a git
clone of Nuitka in a minute. See `Download page </doc/download.html>`_
how to do that.
