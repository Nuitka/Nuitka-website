...
In case of issues with the website, contact me via email:
**Kay.Hayen@gmail.com**

More resources related to Nuitka:
   -  `Nuitka issue tracker <https://github.com/Nuitka/Nuitka/issues>`_

   -  Use `@KayHayen on Mastodon <https://fosstodon.org/@kayhayen>`_ and
      `@KayHayen on Twitter <https://twitter.com/KayHayen>`_ for
      feedback and discussion.

   -  My `YouTube channel
      <https://www.youtube.com/playlist?list=PLKO58t9ADuF6o_Dcmve1DXpUkUEEVvDux>`_
      with presentations of Nuitka at conferences.
